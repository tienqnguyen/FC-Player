...
# First we need to get rid of the messed up parts at the end
# Everything starting with the first export default function SunoLyricDownloader() {
# till the very end of the file should be replaced.
match = re.search(r'export default function SunoLyricDownloader\(\) \{', code)
if match:
    prefix = code[:match.start()]
    
    new_component = """export default function SunoLyricDownloader() {
